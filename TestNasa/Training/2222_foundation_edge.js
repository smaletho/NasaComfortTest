...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Left Kidney<br><br>On the Left kidney initial probe placement is near left purple 2. <br><br>Orient the probe to the kidney using small rotation and sliding.<br><br>Small rotations affect the Length and width of the kidney.<br><br>The best left Kidney is Longest and Widest with BOTH poles in view<br>",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2222_foundation_edgeActions.js");
})("comfortEdge");
