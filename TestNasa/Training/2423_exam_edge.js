...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "STEP 2<br><br>Operator puts gloves on if removed from above procedure.<br><br>Operator re-applies ultrasound gel <br><br>Verify that the ultrasound unit is not frozen.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2423_exam_edgeActions.js");
})("comfortEdge");
