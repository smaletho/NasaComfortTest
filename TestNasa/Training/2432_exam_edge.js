...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 1: HORIZONTAL Bladder<br><br>Operator within reach of ultrasound system and lower pelvis of patient to image the bladder.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2432_exam_edgeActions.js");
})("comfortEdge");
