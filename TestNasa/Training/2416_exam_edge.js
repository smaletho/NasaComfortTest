...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text2',
                            type: 'text',
                            rect: ['34px', '90px', '430px', '433px', 'auto', 'auto'],
                            text: "STEP 5<br><br>Remove gel from your gloved hands and form the right side of the patient needed.<br><br>Prepare for the left kidney next.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2416_exam_edgeActions.js");
})("comfortEdge");
