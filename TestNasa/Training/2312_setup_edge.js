...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            text: "The operator should wear gloves during scanning.<br><br>Bladder patient setup:<br><br>Patient lying on their back. The lower pelvic region exposed ask the patient to slip or lower the clothing to expose the low pelvic area.  Use a towel can be placed between the skin and clothing to reduce gel contact to patients clothing. <br>",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2312_setup_edgeActions.js");
})("comfortEdge");
