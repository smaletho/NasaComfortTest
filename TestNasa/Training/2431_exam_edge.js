...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Review<br><br>Obtain two views of the bladder – horizontal across the bladder and vertical across the bladder.",
                            align: "left",
                        ...
                        },
                        {
                            id: 'Rectangle2',
                            type: 'rect',
                            rect: ['34px', '211px', '297px', '207px', 'auto', 'auto'],
                            fill: ["rgba(192,192,192,1.00)"],
                            stroke: [2,"rgba(255,255,255,1.00)","solid"]
                        },
                        {
                            id: 'Rectangle2Copy',
                            type: 'rect',
                            rect: ['34px', '454px', '297px', '207px', 'auto', 'auto'],
                            fill: ["rgba(192,192,192,1.00)"],
                            stroke: [2,"rgba(255,255,255,1.00)","solid"]
                        }
                    ],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2431_exam_edgeActions.js");
})("comfortEdge");
