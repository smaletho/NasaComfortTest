...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 2: HORIZONTAL Bladder<br><br>Verify: Ultrasound system is not frozen.<br><br>Maintain gloved hands.<br><br>Re-apply ultrasound gel to probe.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2433_exam_edgeActions.js");
})("comfortEdge");
