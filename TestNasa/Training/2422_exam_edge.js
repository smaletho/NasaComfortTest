...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text2',
                            type: 'text',
                            rect: ['34px', '90px', '363px', '274px', 'auto', 'auto'],
                            text: "STEP 1:<br><br>The operator is standing within in reach of the ultrasound and the back of the seated patient.<br><br>Press Erase once then text once, type the letter L onto the ultrasound screen and press text once more",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2422_exam_edgeActions.js");
})("comfortEdge");
