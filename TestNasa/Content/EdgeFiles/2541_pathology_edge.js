...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['468px', '20px', 'auto', 'auto', 'auto', 'auto'],
                            text: "Pathology",
                            align: "right",
                        ...
                        },
                        {
                            id: 'Text3',
                            type: 'text',
                            rect: ['32px', '468px', '384px', '70px', 'auto', 'auto'],
                            text: "Abnormal Bladder this is a  Horizontal projection.<br>Cancer tumor in the bladder arrows define outer edges.<br>",
                            align: "left",
                        ...
                        },
                        {
                            ...
                            text: "Under filled bladder.  There is an inflated Foley catheter in place.  May be considered normal or conformation that the bladder is draining thru the catheter.",
                            align: "left",
                            font: ['Lucida Sans Unicode, Lucida Grande, sans-serif', [12, "px"], "rgba(39,39,39,1)", "400", "none solid rgb(39, 39, 39)", "normal", "break-word", "normal"]
                        },
                        {
                            ...
                            text: "Horizontal bladder post injury.  Swirling blood in urinary sac.",
                            align: "left",
                            font: ['Lucida Sans Unicode, Lucida Grande, sans-serif', [12, "px"], "rgba(39,39,39,1)", "400", "none solid rgb(39, 39, 39)", "normal", "break-word", "normal"]
                        }
                    ],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2541_pathology_edgeActions.js");
})("comfortEdge");
