...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 4: HORIZONTAL Bladder<br><br>Watch the ultrasound screen as you move the probe.  <br><br>Tilt the probe by pointing the cable end of the probe toward the head or opposite direction to obtain the longest view of the bladder.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2435_exam_edgeActions.js");
})("comfortEdge");
