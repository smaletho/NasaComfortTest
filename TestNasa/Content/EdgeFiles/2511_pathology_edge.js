...
(function (compId) {
                    ...
                    dom: [
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['188px', '20px', 'auto', 'auto', 'auto', 'auto'],
                            text: "Normal Anatomy Kidney",
                            align: "right",
                        ...
                        },
                        {
                            id: 'Rectangle',
                            type: 'rect',
                            rect: ['64px', '140px', '400px', '300px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'RectangleCopy',
                            type: 'rect',
                            rect: ['502px', '140px', '400px', '300px', 'auto', 'auto'],
                            fill: ["rgba(192,192,192,1)"],
                            stroke: [1,"rgba(0,0,0,1)","solid"]
                        },
                        {
                            id: 'RectangleCopy2',
                            type: 'rect',
                            rect: ['966px', '140px', '400px', '300px', 'auto', 'auto'],
                            fill: ["rgba(192,192,192,1)"],
                            stroke: [1,"rgba(0,0,0,1)","solid"]
                        },
                        {
                            id: 'Text3Copy2',
                            type: 'text',
                            rect: ['64px', '454px', '309px', '70px', 'auto', 'auto'],
                            text: "Normal kidney ultrasound example",
                            align: "left",
                        ...
                        },
                        {
                            id: 'Text3Copy',
                            type: 'text',
                            rect: ['502px', '454px', '309px', '70px', 'auto', 'auto'],
                            text: "Normal kidney ultrasound example",
                            align: "left",
                            font: ['Lucida Sans Unicode, Lucida Grande, sans-serif', [12, "px"], "rgba(39,39,39,1)", "400", "none solid rgb(39, 39, 39)", "normal", "break-word", "normal"]
                        },
                        {
                            id: 'Text3',
                            type: 'text',
                            rect: ['966px', '454px', '309px', '70px', 'auto', 'auto'],
                            text: "Normal kidney ultrasound example",
                            align: "left",
                            font: ['Lucida Sans Unicode, Lucida Grande, sans-serif', [12, "px"], "rgba(39,39,39,1)", "400", "none solid rgb(39, 39, 39)", "normal", "break-word", "normal"]
                        }
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2511_pathology_edgeActions.js");
})("comfortEdge");
