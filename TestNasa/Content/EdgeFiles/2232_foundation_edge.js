...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Stabilize or steady your hand over the view and press Acquire to store one short clip or cine-loop.<br><br>Pressing the Acquire button saves the image you are seeing digitally.<br><br>You will hear an audible beep after the image is saved.",
                            align: "left",
                        ...
                        },
                        {
                            id: 'Rectangle2Copy2',
                            type: 'rect',
                            rect: ['418px', '125px', '326px', '442px', 'auto', 'auto'],
                            fill: ["rgba(192,192,192,1.00)"],
                            stroke: [2,"rgba(255,255,255,1.00)","solid"]
                        },
                        {
                            id: 'Text8',
                            type: 'text',
                            rect: ['446px', '337px', '274px', '84px', 'auto', 'auto'],
                            text: "close up view",
                            align: "center",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2232_foundation_edgeActions.js");
})("comfortEdge");
