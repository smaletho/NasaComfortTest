...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "STEP 1<br><br>The operator is standing within in reach of the ultrasound and the back of the seated patient.<br><br>Press Text once, type  the letter R onto the ultrasound screen and press text once more <br>",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2412_exam_edgeActions.js");
})("comfortEdge");
