...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 4: VERTICAL Bladder<br><br>Acquire as you see the image technique cine-loop<br><br><br>Temporary store the probe on the ultrasound system. <br><br>Offer patient paper towels to remove gel.<br><br>Remove all traces of gel from the ultrasound probe.<br>Remove gloves.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2444_exam_edgeActions.js");
})("comfortEdge");
