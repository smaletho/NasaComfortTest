...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 5: HORIZONTAL Bladder<br><br>Once you feel you have the longest view of the bladder.  Stabilize or steady your hand over the view and press Acquire. <br><br>Acquire two more cine-loop images from the horizontal bladder.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2436_exam_edgeActions.js");
})("comfortEdge");
