...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 1: VERTICAL Bladder<br><br>Verify that the ultrasound system is not frozen.<br><br>Maintain gloved hands.<br><br>Re-apply ultrasound gel to probe.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2441_exam_edgeActions.js");
})("comfortEdge");
