...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 2: VERTICAL Bladder<br><br>Return probe midline Pelvic Grey 2.<br><br>Rotate the probe over the bladder to a vertical position Reference marker toward the subject’s head.<br><br>Watch the ultrasound screen as you tilt the cable end of the probe toward the patients head until the longest view of the bladder is seen.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2442_exam_edgeActions.js");
})("comfortEdge");
