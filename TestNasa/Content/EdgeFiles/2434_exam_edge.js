...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "Step 3: HORIZONTAL Bladder<br><br>Initial probe placement reference marker to the patient’s right below the hip line on Pelvic Orange",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2434_exam_edgeActions.js");
})("comfortEdge");
