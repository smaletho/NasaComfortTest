...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "STEP 5 <br><br>Remove gel from your gloved hands and form the right side of the patient needed.<br><br>Confirm all gel is removed from the patients back and ready patient for bladder imaging.",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2426_exam_edgeActions.js");
})("comfortEdge");
