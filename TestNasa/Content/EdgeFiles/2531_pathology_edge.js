...
(function (compId) {
                    ...
                    dom: [
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['164px', '20px', 'auto', 'auto', 'auto', 'auto'],
                            text: "Normal Anatomy Bladder",
                            align: "right",
                        ...
                        },
                        {
                            ...
                            text: "Normal horizontal bladder",
                            align: "left",
                        ...
                        },
                        {
                            ...
                            text: "Normal horizontal bladder of a male",
                            align: "left",
                            font: ['Lucida Sans Unicode, Lucida Grande, sans-serif', [12, "px"], "rgba(39,39,39,1)", "400", "none solid rgb(39, 39, 39)", "normal", "break-word", "normal"]
                        },
                        {
                            ...
                            text: "Normal Long bladder of a female.",
                            align: "left",
                            font: ['Lucida Sans Unicode, Lucida Grande, sans-serif', [12, "px"], "rgba(39,39,39,1)", "400", "none solid rgb(39, 39, 39)", "normal", "break-word", "normal"]
                        }
                    ],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("2531_pathology_edgeActions.js");
})("comfortEdge");
